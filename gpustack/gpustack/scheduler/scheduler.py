...
async def find_candidate(
    ...
    # User isolation (feature one): restrict candidates to the workers
    # granted to the model's owner. Admin / platform-owned models keep
    # the full pool.
    from gpustack.policies.worker_filters.worker_access_filter import (
        WorkerAccessFilter,
    )
